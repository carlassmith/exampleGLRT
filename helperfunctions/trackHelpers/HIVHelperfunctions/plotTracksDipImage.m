...
% OUTPUTS:
%   fh: figure handle
%   fhcb: figure handle for colorbar figure
%
% DEPENDENCIES:
%   dipTrack
%   dipTrackSetOptions
%   plotTracksV1
%   plotTracksV1SetOptions
%   plot_colorbar
%
% See also dipTrack, dipTrackSetOptions, plotTracksV1,
% plotTracksV1SetOptions, plot_colorbar
%
% NOTE: if fh is specified in obj.Params.fh and the figure contains a
% dipimage object then that dipimage object will be the background for the
% tracks
%
% Created by Pat Cutler February 2012 (UNM)
